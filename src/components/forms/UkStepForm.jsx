...
const UkStepForm = () => {
  ...
  const [questions, setQuestions] = useState([
    ...
    },
    {
      ...
      type: "dropdown",
      options: [
        { label: "1-6 Ay", value: "1-6 Ay" },
        { label: "6-12 Ay", value: "6-12 Ay" },
        { label: "1-2 yıl", value: "1-2 yıl" },
        { label: "2-3 yıl", value: "2-3 yıl" },
        { label: "3-4 yıl", value: "3-4 yıl" },
        { label: "5+ Yıl", value: "5+ yıl" },
      ],
      otherInputs: [
        {
          id: 1,
    ...
    },
    {
      ...
      otherInputs: [
        ...
        {
          id: 2,
          label: "Seyahat amacları (Turizm, iş, eğitim, aile ziyareti vb.) (Her ülke için ayrı ayrı belirtiniz)",
