...
- Tam Ad (Soyadı, Adı, İkinci Adı)
- Daha önce kullanılan diğer isimler (Takma ad, evlenmeden önceki soyadı vb.)
- Cinsiyet
- Doğum tarihi ve yeri (Şehir, Ülke)
- Vatandaşlık bilgileri
- Şu anki ikamet edilen ülke ve statüsü
- Son 5 yılda başka ülkelerde 6 aydan uzun süre yaşadı mı?


Medeni Durum

- Mevcut medeni durumu (Bekar, Evli, Dul, Boşanmış vb.)
- Evli ise eşin adı ve doğum tarihi
- Evli ise başlangıç tarihi
- Mevcut meslek
- Şu anki ikamet adresi
- Önceki evlilik bilgileri (varsa)-Ad soyad-Eski eş adı-Evlilik ve boşanma tarihi


Pasaport Bilgileri

- Pasaport numarası
- Pasaport düzenleyen ülke
- Pasaport veriliş ve son geçerlilik tarihi
- Kullanılan pasaportun türü (Standart, Diplomatik vb.)

Dil Bilgileri

- Ana dili
- İngilizce veya Fransızca iletişim kurabilir mi?
- İngilizce veya Fransızca dil sınavı geçmişi


İletişim Bilgileri

- Mevcut ikamet adresi (Ülke, Şehir, Posta Kodu vb.)
- Telefon ve e-posta bilgileri
- Başvuru sürecinde iletişim için tercih edilen yöntem


Kanada Ziyareti Detayları

- Ziyaret amacı (Turizm, İş, Aile ziyareti vb.)
- Kanada’da planlanan kalış süresi (Giriş ve Çıkış tarihleri)
- Kalış süresince kullanılabilecek maddi kaynaklar (CAD cinsinden)
- Kanada’da ziyaret edilecek kişi/kurum bilgileri (İsim, Adres, İlişki türü)

Eğitim Bilgileri

- En yüksek tamamlanan eğitim seviyesi
- Okul adı, alanı ve mezuniyet yılı
- Eğitimin yapıldığı ülke

İş Geçmişi (Son 10 Yıl)

- Mevcut iş durumu (Çalışan, Emekli, Öğrenci vb.)
- Şirket/işveren adı, adresi ve pozisyonu
- Önceki iş deneyimleri (Son 10 yılda boşluk bırakılmadan)

Arka Plan Bilgileri (Güvenlik ve Suç Geçmişi)
- Son 2 yılda tüberküloz veya bulaşıcı bir hastalık teşhisi kondu mu?
- Daha önce Kanada veya başka bir ülkeye giriş reddi yaşandı mı?
- Daha önce Kanada'da izinsiz çalışma veya eğitim alındı mı?
- Suç geçmişi (Herhangi bir suçtan dolayı tutuklanma, mahkumiyet vb.)
- Askeri hizmet, güvenlik güçleri veya polis teşkilatında görev yapıldı mı?
- Politik örgüt üyelikleri veya şiddet yanlısı gruplarla ilişki var mı?
- İnsan hakları ihlallerine tanıklık edildi mi veya katılım sağlandı mı?
...
1. Askeri Hizmet ve Güvenlik Kuvvetleri Deneyimi
• Askerlik, milis veya sivil savunma birimlerinde görev yapıldı mı?
• Polis teşkilatı veya güvenlik organizasyonlarında görev alındı mı?
• Görev süresi (Başlangıç ve bitiş tarihleri)
• Görev yeri (Şehir, Eyalet/Bölge, Ülke)

2. İnsan Hakları İhlalleri ve Suç Geçmişi
• Savaş suçları, soykırım veya insanlığa karşı suçlarda herhangi bir rol oynandı mı?
• Tutuklanma veya suç mahkumiyeti geçmişi var mı?
• Mahkumiyet detayları (Tarih, yer, suç türü)

3. Örgüt Üyelikleri ve Politik Bağlantılar
• Daha önce herhangi bir siyasi partiye veya şiddeti savunan bir gruba üye olundu
mu?
• Örgüt adı, faaliyetleri ve organizasyon içindeki pozisyonlar

4. Devlet Pozisyonları
• Hakim, polis memuru, belediye başkanı, milletvekili, kamu çalışanı gibi bir hükümet
pozisyonunda görev yapıldı mı?
• Görev süresi ve hükümet departmanı bilgileri
• Yargı seviyesi (Ulusal, Bölgesel, Yerel)

5. Önceki Seyahatler
• Son 5 yılda veya 18 yaşından sonra başka ülkelere seyahat edildi mi?
• Seyahat edilen ülkeler, seyahat tarihleri ve seyahat amacı
  */
